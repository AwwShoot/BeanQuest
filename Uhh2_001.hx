...
@:keep class Uhh2_001 extends armory.logicnode.LogicTree {
	...
	override public function add() {
		...
		_Keyboard_017.property0 = "released";
		...
		_MathExpression.property0 = "(a-b)*500";
		...
		_SendGlobalEvent_002.addInput(_ApplyForce, 0);
		_SendGlobalEvent_002.addInput(new armory.logicnode.StringNode(this, "move"), 0);
		_SendGlobalEvent_002.addOutputs([new armory.logicnode.NullNode(this)]);
		_ApplyForce.addOutputs([_SendGlobalEvent_002]);
		...
		_SendGlobalEvent_003.addInput(_ApplyForce_001, 0);
		_SendGlobalEvent_003.addInput(new armory.logicnode.StringNode(this, "move"), 0);
		_SendGlobalEvent_003.addOutputs([new armory.logicnode.NullNode(this)]);
		_ApplyForce_001.addOutputs([_SendGlobalEvent_003]);
		...
		_MathExpression_001.property0 = "(a-b)*500";
		...
		_SendGlobalEvent_001.addInput(new armory.logicnode.NullNode(this), 0);
		_SendGlobalEvent_001.addInput(_RotateObject_001, 0);
		_SendGlobalEvent_001.addOutputs([new armory.logicnode.NullNode(this)]);
		_RotateObject_001.addOutputs([_SendGlobalEvent_001]);
		...
		_SendGlobalEvent.addInput(_RotateObject, 0);
		_SendGlobalEvent.addInput(new armory.logicnode.StringNode(this, "move"), 0);
		_SendGlobalEvent.addOutputs([new armory.logicnode.NullNode(this)]);
		_RotateObject.addOutputs([_SendGlobalEvent]);
		...
		_Vector.addInput(new armory.logicnode.FloatNode(this, 5.0), 0);
